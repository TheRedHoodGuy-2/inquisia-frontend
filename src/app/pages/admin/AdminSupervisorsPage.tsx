  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        className="fixed inset-x-4 top-1/2 -translate-y-1/2 max-w-sm mx-auto bg-white dark:bg-[#111115] rounded-2xl border border-[#E4E7EC] dark:border-[#222229] shadow-2xl z-50 overflow-hidden"
      ...
      >
        ...
        <div className="flex items-start justify-between px-5 pt-5 pb-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2
                className="text-[15px] text-[#0A0A0F] dark:text-[#F5F5F5] mb-0.5"
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-full hover:bg-[#F2F4F7] dark:hover:bg-[#18181D] text-[#9CA3AF] flex-shrink-0"
          >
            <X size={15} />
          </button>
        </div>
        ...
        <div className="px-5 pb-2">
          <p
            className="text-[13px] text-[#5C6070] dark:text-[#8B8FA8] mb-3"
          ...
          <textarea
            ...
            className="w-full rounded-2xl border border-[#E4E7EC] dark:border-[#222229] bg-[#F2F4F7] dark:bg-[#18181D] px-3 py-2.5 text-[13px] text-[#0A0A0F] dark:text-[#F5F5F5] placeholder-[#9CA3AF] outline-none resize-none focus:border-[#0066FF] focus:shadow-[0_0_0_2px_rgba(0,102,255,0.12)] transition-all"
            style={{ fontFamily: 'var(--font-body)' }}
          />
          <span
        ...
        <div className="px-5 pb-5 pt-3 flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 py-2.5 rounded-full text-[13px] border border-[#E4E7EC] dark:border-[#222229] text-[#5C6070] hover:border-[#0066FF] hover:text-[#0066FF] transition-colors"
...
export function AdminSupervisorsPage() {
  ...
  const Section = ({
    ...
    <div className="mb-8">
      <h2
        className="text-[16px] text-[#0A0A0F] dark:text-[#F5F5F5] mb-4"
        style={{ fontFamily: 'var(--font-display)', fontWeight: 600 }}
      >
        {title} ({items.length})
      </h2>
      {items.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-[#E4E7EC] dark:border-[#222229] py-10 text-center">
        ...
        <div
          className="rounded-2xl bg-white dark:bg-[#111115] border border-[#E4E7EC] dark:border-[#222229] overflow-hidden"
        ...
        >
          {items.map((s, i) => {
            ...
            return (
              <div
                key={s.id}
                className={`flex flex-col sm:flex-row sm:items-center gap-3 px-5 py-4 ${i > 0 ? 'border-t border-[#E4E7EC] dark:border-[#222229]' : ''}`}
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      className="text-[13px] font-semibold text-[#0A0A0F] dark:text-[#F5F5F5]"
  ...
  return (
    <div>
      <div className="mb-6">
        <h1
          className="text-[#0A0A0F] dark:text-[#F5F5F5] mb-1"
          style={{
