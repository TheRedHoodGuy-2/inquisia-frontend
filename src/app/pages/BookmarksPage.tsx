...
function BookmarkCard({ project, onRemove }: { project: Project; onRemove: (id: string) => void }) {
  ...
  return (
    <motion.div
      ...
      className="relative rounded-2xl border border-[#E4E7EC] dark:border-[#222229] bg-white dark:bg-[#111115] p-6 cursor-pointer"
      style={{
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 right-4 p-1.5 rounded-full bg-[#F2F4F7] dark:bg-[#18181D] text-[#9CA3AF] hover:bg-red-50 dark:hover:bg-red-900/10 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100"
      ...
      <div className="flex items-start gap-3">
        <div className="flex-1 min-w-0">
          ...
          {/* Abstract snippet */}
          <p
            className="text-[13px] text-[#5C6070] dark:text-[#8B8FA8] line-clamp-2 mb-4"
    ...
    <DashboardLayout activeSection="bookmarks">
      <div className="max-w-[1000px] mx-auto">
        ...
        {bookmarkedIds.length > 0 && (
          <div className="flex items-center gap-2 bg-white dark:bg-[#111115] rounded-full border border-[#E4E7EC] dark:border-[#222229] px-4 py-2.5 mb-6 max-w-md">
