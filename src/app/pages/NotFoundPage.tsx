  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-5">
      ...
      >
        ...
        <h1 className="text-[24px] text-[#0A0A0F] dark:text-[#F5F5F5] mb-3"
        ...
        <div className="flex items-center gap-3 justify-center">
          ...
          <Link to="/projects"
            className="px-6 py-3 rounded-full text-[14px] text-[#5C6070] border border-[#E4E7EC] dark:border-[#222229] hover:border-[#0066FF] hover:text-[#0066FF] transition-colors"
            style={{ fontFamily: 'var(--font-body)', fontWeight: 500 }}>
            Browse Projects
          </Link>
        </div>
